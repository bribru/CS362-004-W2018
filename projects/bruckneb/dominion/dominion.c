...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
		case adventurer:
			return cardEffect_Adventurer(choice1, choice2, choice3, state, handPos, bonus);			

		case council_room:
			return cardEffect_CouncilRoom(choice1, choice2, choice3, state, handPos, bonus);
		...
		case smithy:
			return cardEffect_Smithy(choice1, choice2, choice3, state, handPos, bonus);

		case village:
			return cardEffect_Village(choice1, choice2, choice3, state, handPos, bonus);
		...
		case great_hall:
			return cardEffect_GreatHall(choice1, choice2, choice3, state, handPos, bonus);
